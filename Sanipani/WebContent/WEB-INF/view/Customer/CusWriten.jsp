...
$(document).ready(function(){
	...
	$("#CusinsBtn").on("click", function(){
		var CusActionForm = $("#CusActionForm");
		
		
		CusActionForm.ajaxForm(Cusadd);
		
		CusActionForm.submit();
	});
...
function Cusadd(data, result){
	if(result == "success"){
		...
		var params = $("#CusActionForm").serialize();
...
<body><div class="main">
	...
	<div class="main1">
		...
		<div class="content2"> 		 
			...
			<div class="Writebar">
			<input type="button" id="CusinsBtn" value="작성">
			<input type="button" id="CusCanBtn" value="취소">
			</div>
		</div>
			</div>	
	 </div>
