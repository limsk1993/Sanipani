...
<div class="main">
	...
	<div class="main1">
		...
		<div class="content">
			...
			<div class="yd">
				<div class="yd1">이용약관, 개인정보 수집 및 이용,<br/>
					  위치정보 이용약관(선택), 프로모션 안내<br/>
					  메일 수신(선택)에 모두 동의합니다 </div>


					<input type='checkbox' id='check_all' class='input_check' /><b>전체선택</b>
					<br/>
					<br/>
					<div class="yd1">사니파니 이용약관 동의(필수) </div>
					<input type='checkbox' class='input_check' id="ch1" name='class1' value='1' /> <b>1</b>
					<textarea rows="7"cols="57">
제 1 조 (목적)
이 약관은 사니파니 주식회사 ("회사" 또는 "사니파니")가 제공하는 사니파니 및 사니파니 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 사니파니 및 사니파니 관련 제반 서비스를 의미합니다.
...
- 게시중단요청서비스 : http://help.sanipani.com/claim_main.asp 
제 17 조 (권리의 귀속)
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다. 
					...
					<div class="yd1">개인정보 수집 및 이용에 대한 안내(필수) </div>	
					<input type='checkbox' class='input_check' id="ch2" name='class2' value='2' /> <b>2</b>
					<textarea rows="7"cols="57">
정보통신망법 규정에 따라 사니파니에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 사니파니 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 사니파니는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
회원가입 시점에 사니파니가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
sanipani 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.
...
2. 수집한 개인정보의 이용
사니파니는 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.
- 회원 가입 의사의 확인, 연령 확인 및 법정대리인 동의 진행, 이용자 및 법정대리인의 본인 확인, 이용자 식별, 회원탈퇴 의사의 확인 등 회원관리를 위하여 개인정보를 이용합니다.
- 콘텐츠 등 기존 서비스 제공(광고 포함)에 더하여, 인구통계학적 분석, 서비스 방문 및 이용기록의 분석, 개인정보 및 관심에 기반한 이용자간 관계의 형성, 지인 및 관심사 등에 기반한 맞춤형 서비스 제공 등 신규 서비스 요소의 발굴 및 기존 서비스 개선 등을 위하여 개인정보를 이용합니다.
- 법령 및 사니파니 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.
...
결제도용, 불법할인대출(일명 '카드깡') 등 관련 법령 및 이용약관을 위반하는 사니파니페이의 부정거래기록(아이디, 이름, 휴대폰번호, 배송지 주소, IP주소, 쿠키, 기기정보)은 부정거래 방지 및 다른 선량한 이용자의 보호, 안전한 거래 환경 보장을 위하여 수집 시점으로부터 3년간 보관하고 파기합니다.
전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. 사니파니는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.
...
로그인 기록: 3개월 
					...
					<div class="yd1">위치정보 이용약관 동의(선택)  </div>	
					<input type='checkbox' class='input_check' name='class3' value='3' /> <b>3</b>
					<textarea rows="7"cols="57">
위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 사니파니 위치기반 서비스를 이용할 수 있습니다.
제 1 조 (목적)
이 약관은 사니파니 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (약관 외 준칙)
...
상호: 사니파니 주식회사
주소: 경기도 성남시 분당구 불정로 6 사니파니 그린팩토리 (463-867) 
전화번호: 1588-3820
이메일 주소: sanipanicc@sanipani.com
부칙 
제1조 시행일
...
전화번호 : 1588-3820
이메일 주소 : privacy@sanipani.com
					</textarea>
					<div class="yd1">이벤트 등 프로모션 알림 메일 수신(선택)  </div>	
					<input type='checkbox' class='input_check' name='class4' value='4' /> <b>4</b>
					<br/>
					<br/>
					<div class="de">
					<input class="de_Btn" type="button" value="동의" /><input class="de_Btn1" type="button" value="비동의"/>
					</div>
				</div>	
			</div>
		</div>
