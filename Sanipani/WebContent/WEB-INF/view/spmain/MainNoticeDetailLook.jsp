...
<div class="main">
	...
	<div class="main1">
		...
		<table border="1">
			...
			<tr>
				<th>제목</th>
				<td><textarea rows="10" cols="80" readonly="readonly" style="margin: 0px; min-width:685px; max-width:685px; min-height:15px; max-height:15px;">${con.NOTICETITLE}</textarea></td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea rows="10" cols="80" readonly="readonly" style="margin: 0px; min-width:685px; max-width:685px; min-height:186px; max-height:186px;">${con.NOTICECONTENT}</textarea></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td>${con.NICK}</td>
			...
			<tr>
				<th>작성일</th>
				<td>${con.NOTICEWRITERDATE}</td>
			</tr>
		</table>
		<br/>
		<input type="button" value="수정" id="NoticeUpdate" />
		<input type="button" value="삭제" id="NoticeDelete" />
		<input type="button" value="뒤로가기" id="NoticeHome" />
		</div>
	</div>
	<div class="right">
